<div class="research-layout">
  <article class="research-card research-card--wide">
    <span class="card-kicker">RESEARCH / 2025.12 — 2026.07</span>
  ...
  <article class="research-card">
    <span class="card-kicker">ENGINEERING PRACTICE</span>
    <h3>Agent systems</h3>
    <ul>
      <li>熟悉 LangChain、ReAct、Tool Calling、记忆系统与多智能体编排。</li>
      <li>能够使用 Python 完成接口调用、数据处理、自动化工具封装和服务部署。</li>
      <li>关注 RAG、MCP、向量检索、上下文拼接与可观测的 Agent 工作流。</li>
    </ul>
  </article>
</div>
